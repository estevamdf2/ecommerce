...
public class FraudeDetectorService {
    ...
    private static Properties properties() {
        ...
        //Gerando um identificador único para a fila
        properties.setProperty(ConsumerConfig.CLIENT_ID_CONFIG, FraudeDetectorService.class.getName() + "-" + UUID.randomUUID().toString());
